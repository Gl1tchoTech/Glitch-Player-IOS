...
main_target_settings = {
    ...
    "INFOPLIST_KEY_CFBundleDisplayName": "ErrorStream",
    ...
    "PRODUCT_BUNDLE_IDENTIFIER": "com.errorstream.app",
...
widget_target_settings = {
    ...
    "CURRENT_PROJECT_VERSION": "1",
    "GENERATE_INFOPLIST_FILE": "YES",
    "INFOPLIST_KEY_CFBundleDisplayName": "ErrorStream Widget",
    "INFOPLIST_KEY_NSHumanReadableCopyright": '""',
    "MARKETING_VERSION": "1.0",
    "PRODUCT_BUNDLE_IDENTIFIER": "com.errorstream.app.widget",
    "PRODUCT_NAME": '"$(TARGET_NAME)"',
    "SKIP_INSTALL": "YES",
    "SWIFT_EMIT_LOC_STRINGS": "YES",
    "TARGETED_DEVICE_FAMILY": '"1,2"',
